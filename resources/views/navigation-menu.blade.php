        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-jet-nav-link href="{{ route('worker.work.index') }}"
                        :active="request()->routeIs('worker.work.index')">
                        {{ __('Work') }}
                    </x-jet-nav-link>
                    @endif

                    @can('manage-courses')
                    <x-jet-nav-link href="{{ route('hirer.hire.index') }}"
                        :active="request()->routeIs('hirer.hire.index')">
                        {{ __('Hire') }}
                    </x-jet-nav-link>
                    @endif
                </div>
